...
if (!class_exists(Debugger::class)) {
    ...
    require_once __DIR__ . '/src/handlers-basic/ErrorHandler.php';
    require_once __DIR__ . '/src/handlers-basic/ExceptionHandler.php';
    require_once __DIR__ . '/src/handlers-basic/MemoryHandler.php';
    require_once __DIR__ . '/src/handlers-basic/OutputHandler.php';
    require_once __DIR__ . '/src/handlers-basic/RequestHandler.php';
    require_once __DIR__ . '/src/handlers-basic/ResourcesHandler.php';
    require_once __DIR__ . '/src/handlers-basic/ShutdownHandler.php';

    require_once __DIR__ . '/src/handlers-database/RedisHandler.php';
    require_once __DIR__ . '/src/handlers-database/SqlHandler.php';

    require_once __DIR__ . '/src/handlers-intercept/CurlHandler.php';
    require_once __DIR__ . '/src/handlers-intercept/DnsHandler.php';
    require_once __DIR__ . '/src/handlers-intercept/FilesHandler.php';
    require_once __DIR__ . '/src/handlers-intercept/MailHandler.php';
    require_once __DIR__ . '/src/handlers-intercept/SettingsHandler.php';
    require_once __DIR__ . '/src/handlers-intercept/SessionHandler.php';
    require_once __DIR__ . '/src/handlers-intercept/StreamHandler.php';
    require_once __DIR__ . '/src/handlers-intercept/SyslogHandler.php';

    require_once __DIR__ . '/src/handlers-stream/StreamHandlerShared.php';
    require_once __DIR__ . '/src/handlers-stream/DataStreamHandler.php';
    require_once __DIR__ . '/src/handlers-stream/FileStreamHandler.php';
    require_once __DIR__ . '/src/handlers-stream/FtpStreamHandler.php';
    require_once __DIR__ . '/src/handlers-stream/HttpStreamHandler.php';
    require_once __DIR__ . '/src/handlers-stream/PharStreamHandler.php';
    require_once __DIR__ . '/src/handlers-stream/PhpStreamHandler.php';
    require_once __DIR__ . '/src/handlers-stream/ZlibStreamHandler.php';
